...
MODIFY Nro_Telefono TEXT NOT NULL;
...
ALTER TABLE SOLICITUD
ADD Password_hash BINARY NOT NULL;

ALTER TABLE SOLICITUD
CHANGE Estado Estado_Solicitud ENUM('Pendiente','Aprobada','Rechazada') DEFAULT 'Pendiente';
...
ALTER TABLE PERSONA
MODIFY Password_hash BINARY NOT NULL;

ALTER TABLE PERSONA
MODIFY Password_hash BINARY NULL;
...
ALTER TABLE SOCIO
ADD CONSTRAINT fk_CI_Socio FOREIGN KEY (CI) references PERSONA(CI);

ALTER TABLE PERSONA
ADD CONSTRAINT fk_ID_Unidad_Habitacional_Persona FOREIGN KEY (ID_Unidad_Habitacional) references UNIDAD_HABITACIONAL (ID_Unidad_Habitacional);
