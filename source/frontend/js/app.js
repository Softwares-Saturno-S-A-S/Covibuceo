...
document.getElementById("form-registro").addEventListener("submit", async e => {
    ...
    switch (status) {
        ...
        case 201: // Exito, solicitud agregada correctamente
            ...
            window.location.href = "/frontend/Landing_Page/aceptado.html?mensaje=aceptado" ; //Redirige a una nueva pestaña pasando como parámetro el mensaje recibido de la API.
        break;
